/**
 * OwnerSignupPage
 * Invite-based and self-registration for property owners
 */

import React, { useState, useMemo } from 'react';
import { useParams, useNavigate, Link } from 'react-router-dom';
import { Eye, EyeOff, Check, X, AlertCircle, Loader2, Building2, UserPlus } from 'lucide-react';
import { Button } from '../../components/ui/Button';
import { Input } from '../../components/ui/Input';
import { Card } from '../../components/ui/Card';
import { useQuery } from '@tanstack/react-query';
import { validateInviteCode, submitRegistrationRequest } from '../../services/owner/ownerInviteService';
...
export default function OwnerSignupPage() {
  ...
  const {
    ...
    queryKey: ['owner-invite', inviteCode],
  ...
  const handleInviteSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Update owner record with user_id
      ...
      if (ownerError) {
        console.error('Failed to link owner:', ownerError);
      }
  ...
  const handleRegistrationSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const result = await submitRegistrationRequest(regForm);
  ...
  if (mode === 'invite' && isValidating) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-50 via-white to-teal-50 dark:from-neutral-900 dark:via-neutral-800 dark:to-neutral-900">
  ...
  if (mode === 'invite' && inviteCode && (hasInviteError || !invite?.valid)) {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-50 via-white to-teal-50 dark:from-neutral-900 dark:via-neutral-800 dark:to-neutral-900 px-4">
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-50 via-white to-teal-50 dark:from-neutral-900 dark:via-neutral-800 dark:to-neutral-900 px-4 py-8">
      <div className="w-full max-w-md">
        ...
        <Card className="p-8">
            ...
            <div className="flex mb-6 bg-gray-100 dark:bg-neutral-700 rounded-lg p-1">
              <button
                ...
                className={`flex-1 py-2 px-4 rounded-md text-sm font-medium transition-colors ${
                  mode === 'invite'
                    ? 'bg-white dark:bg-neutral-800 text-emerald-600 shadow'
            ...
            <>
              <div className="text-center mb-6">
                <h2 className="text-2xl font-semibold text-gray-900 dark:text-white">
                  Welcome, {invite.first_name || 'Owner'}!
                </h2>
                <p className="text-gray-600 dark:text-neutral-300 mt-1">
                  Create your account to access your portfolio
                </p>
              </div>
                    ...
                    {requirementsMet.map((req) => (
                      <div
                        ...
                        className={`flex items-center gap-2 text-sm ${
                          req.met ? 'text-emerald-600' : 'text-gray-500 dark:text-neutral-400'
                        }`}
                      >
          ...
          {mode === 'register' && (
            <>
              <div className="text-center mb-6">
                ...
                <p className="text-gray-600 dark:text-neutral-300 mt-1">
                  Submit your information for property manager approval
                </p>
              </div>
              ...
              <form onSubmit={handleRegistrationSubmit} className="space-y-4">
                ...
                <Input
                  ...
                  value={regForm.property_address}
                  onChange={(e) => setRegForm({ ...regForm, property_address: e.target.value })}
                  placeholder="Address of property you own"
                />
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-3 py-2 border border-gray-300 dark:border-neutral-600 rounded-md focus:outline-none focus:ring-2 focus:ring-emerald-500 dark:bg-neutral-700 dark:text-white"
                    rows={3}
          ...
          {/* Mode toggle for invite */}
          {mode === 'invite' && !invite?.valid && !inviteCode && (
            <div className="text-center">
              <Input
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-600 dark:text-neutral-300 text-sm">
              ...
              <Link to="/owner/login" className="text-emerald-600 hover:text-emerald-700 font-medium">
                Login here
              </Link>
            </p>
          </div>
